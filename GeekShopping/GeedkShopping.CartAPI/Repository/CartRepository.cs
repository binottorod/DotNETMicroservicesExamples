    ...
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<bool> RemoveFromCart(long cartDetailsId)
        {
            try
            {
                ...
                if (total == 1)
                {
                    var cartHeaderToRemove = await _context.CartHeaders.FirstOrDefaultAsync(c => c.Id == cartDetail.Id);
        ...
        public async Task<CartVO> SaveOrUpdateCart(CartVO vo)
        {
            ...
            //Checks if product is already saved in the db, it it does not
            //exist then save
            ...
            {
                //Creat CartHeader and CartDetails
